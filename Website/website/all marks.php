...
$query_rs_mark = "SELECT * FROM mark WHERE batch='$batch' AND class='$class'";
...
<div id="navBar" align="center">
   <ul>
     ...
     <li class="currentpage"><a href="all marks.php">Marks Sheet</a></li>
...
<form method="post" action="all marks.php">
