...
<form ACTION="<?php echo $loginFormAction; ?>" name="login" method="POST">
  ...
  <p class="colour"><strong>Invalid user credentials!</strong></p>
  
  <p><span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif"></span>
