...
<div id="navBar" align="center">
  <ul>
     ...
     <li  class="currentpage"><a href="studentlist.php">Student List</a></li>
...
<p align="center"><span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; color: #FFF;"><strong>Batch </strong></span>
...
&nbsp;&nbsp;  
 <input type="submit" class="ui-corner-all" id="submit" value="Display"></p>
</form>
...
<?php
  ...
  <table width="350" border="1" align="center">
    <tr>
      <th width="100" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; color: #CCC; text-align: center; font-size: 18px;" scope="col">Roll No.</th>
      <th width="250" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; color: #CCC; text-align: left; font-size: 18px;" scope="col">Name</th>
    </tr> 
