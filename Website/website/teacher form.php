...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE teacher SET password=%s, name=%s, desig=%s, dept=%s, tutor=%s, email=%s, mobileno=%s WHERE teacherID='$user_check'",
...
mysql_select_db($database_con_db, $con_db);
$query_rs_teacherform = "SELECT * FROM teacher WHERE teacherID='$user_check'";
$rs_teacherform = mysql_query($query_rs_teacherform, $con_db) or die(mysql_error());
$row_rs_teacherform = mysql_fetch_assoc($rs_teacherform);
$totalRows_rs_teacherform = mysql_num_rows($rs_teacherform);
?>
...
<h1 align="center" style="color: #CCC; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif;">&nbsp;</h1>
...
<form action="<?php echo $editFormAction; ?>" name="form" method="POST" onSubmit="return checkForm(this);">
 ...
 <p align="center" style="color: #999"><span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; color: #FFF;"> &nbsp; Name </span>
  ...
  <input name="Name" type="text" required class="ui-corner-all" id="fullname" value="<?php echo $row_rs_teacherform['name']; ?>"></p>
 
 <p align="center" style="color: #FFFFFF; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif;"><span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; color: #FFF;">  Designation</span>
 ...
 <p align="center" style="color: #FFFFFF; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Group Tutor
   <select name="tutor" class="ui-corner-all" id="tutor"> 
   		<option></option>
 ...
 <p align="center" style="color: #FFF; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif;">
  ...
  <p align="center" style="color: #FFF; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif;">&nbsp;Current Password
   ...
   <input name="password1" type="password" class="ui-corner-all" id="password1"></p>  
...
<?php
mysql_free_result($rs_teacherform);
?>
